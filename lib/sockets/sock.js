...
var heartbeat = require('../plugins/heartbeat')
...
Socket.prototype.use = function(plugin, options){
  plugin(this, options);
  return this;
};
...
Socket.prototype.connect = function(port, host, fn){
  ...
  sock.on(connectEvent, function() {
    ...
    self.connected = true;
    self.addSocket(sock);
    // if (self.enabled('heartbeat')) Setheartbeat(self)
    self.retry = 0;
